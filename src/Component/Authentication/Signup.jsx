      ...
      <div class="login">
        ...
        <div class="fields">
            <div className='username'>
              <PersonIcon /> <input type="text" name='name' className='userName' placeholder='Enter your name'  value={formData.name}
            ...
            <div class="username"><svg class="svg-icon" viewBox="0 0 20 20">
              ...
              <input type="email" class="user-input" name='email' placeholder='Enter your email' value={formData.email}
            ...
            <div class="password"><svg class="svg-icon" viewBox="0 0 20 20">
              ...
              <input type="password" class="passinput" name='passWord' placeholder=' Password'  value={formData.passWord}
              onChange={handleChange}/></div>
        </div>
        <button class="singin">Signup</button>
